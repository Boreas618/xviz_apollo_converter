...
var XVIZBuilder = function () {
  ...
  (0, _createClass2["default"])(XVIZBuilder, [{
    ...
    value: function getMessage() {
      ...
      if (!ts && poses && poses[_constant.PRIMARY_POSE_STREAM]) {
        ts = poses[_constant.PRIMARY_POSE_STREAM].timestamp;
      }

      if (!ts) {
        this._validator.error("A message requires a timestamp. Ensure builder.timestamp() is called.");
      }
